...
async function main(args: string[]): Promise<void> {
  ...
  if (adtMsgType === 'A01') {
    parsedMessage =
      ...
      EVN||200912231035|||MT^MEDITECH|200912231033|
      ...
      PV1|1|I|SGYOTH^${roomNo}^A|EMER|||ANG^DOCTOR^SYLVIA^^^^M.D.^^^^^^XX|||CAR||||SELF|||BEA^BEAU^FAKE^L.^^^M.D.^^^^^^XX|IN||BC|||||||||||||||||||DCH||ADM|||2009 12231033||||||||BRAJA^FAKE^JAMES^E^^^M.D.^^^^^^XX|
